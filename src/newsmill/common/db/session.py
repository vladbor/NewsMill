"""Async database session management shared between services.

Both the Worker and the Monitor use the same engine/session helpers. The
database URL is assembled from ``DB_*`` settings (see :class:`Settings`).
"""
